...
void receiveI2C(int bytesIn)
{
  ...
  datos = String(instruction[0]) + "," + String(instruction[1]) + "," + String(instruction[2]) + "," + instruction[3] + "," + String(instruction[4]);
...
void requestEvent()
{ 
  int moviment = ((x.substring(0,1)).toInt());
  int velocitat = ((x.substring(2,4)).toInt());
  Wire.write(moviment);
