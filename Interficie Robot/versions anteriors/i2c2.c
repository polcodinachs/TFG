...
task main()
{
    while(true){
        ...
        i2c_read_registers_text(1, 1, 0);       // Here we're going to get back "Dexter" because we're writing to the 0x01 register.
        //i2c_read_registers_text(0x02, 1, 10);       // Here we're going to get back "Industries" because we're weriting to the 0x00 register.
 				wait1Msec(1000);
    }
